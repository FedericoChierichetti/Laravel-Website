        ...
        <div class="">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <hr>
                    <label class="me-3">Pret Original: <s>{{ $products->original_price }} Lei</s></label>
                    <label class="fw-bold">Pret: {{ $products->selling_price }} Lei</label>
                    ...
                    @foreach ($reviews as $item)
                        <div class="user-review">
                            ...
                            @if($item->user_id == Auth::id())
                                <a href="{{ url('edit-review/'.$products->slug.'/userreview') }}" class="underline-btn">Editeaza Review</a>
                            @endif
                            <br>
                            @php 
