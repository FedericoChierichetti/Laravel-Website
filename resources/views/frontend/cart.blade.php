    ...
    <div class="card shadow cartitems">
        @if($cartitems->count() > 0)
            ...
            <div class="card-footer">
                <h6>Pret Total : {{ $total }}  Lei
                    <a href="{{ url('checkout') }}" class="btn btn-outline-success float-end">Lanseaza Comanda</a>
                </h6>
            </div>
        @else
            <div class="card-body text-center">
                <h2><i class="fa fa-shopping-cart"></i> Cosul tau este gol</h2>
                <a href="{{ url('category') }}" class="btn btn-outline-primary float-end">Continua Cumparaturile</a>
            </div>
        @endif 
    </div>
</div>
